...
/**
 * If there is an error in the server, the display error message
 */
...
/**
 * Get all the information for the login info
 */
...
/**
 * Handle all different user request, such as download and preview
 */
